...
import 'package:islamic_marriage_usa_app/screens/my_biodata_screen/widgets/empty_biodata_section.dart';
...
class MyBiodataScreen extends StatelessWidget {
  MyBiodataScreen({super.key});

  final _controller = Get.find<MyBiodataController>();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBarWithTitle(
          onPressed: () => Get.back(), title: 'My Bio Data'),
      body: GetBuilder<MyBiodataController>(
          builder: (controller) => controller.isLoading
              ? AppConstFunctions.customCircularProgressIndicator
              : controller.myBiodata?.data == null
                  ? EmptyBiodataSection()
                  : Padding(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Gap(8.h),
                                  Text(
                                    'Biodata No: ${controller.myBiodata?.data?.bioDataId ?? "N/A"}',
                                  ...
                                  Gap(8.h),
                                  if (controller
                                          .myBiodata?.data?.step1GeneralInfo !=
                                      null)
                                    CustomBioDataTable(
                            ...
                            if (controller.myBiodata?.data?.step2AddressInfo !=
                                null)
                              CustomExpansionTile(
                                  title: 'Address Info',
                                  children: [
                            ...
                            if (controller.myBiodata?.data
                              ...
                              CustomExpansionTile(
                                  ...
                                  children: [
                                    CustomBioDataTable(
                                      data: removeEmptyFields(
                                          generateEduQualificationInfo()),
                                    )
                                  ]),

                            // Family Info Section
                            if (controller.myBiodata?.data?.step4FamilyInfo !=
                                null)
                              CustomExpansionTile(
                                  title: 'Family Info',
                                  children: [
                            ...
                            if (controller.myBiodata?.data?.step5PersonalInfo !=
                                null)
                              CustomExpansionTile(
                            ...
                            if (controller
                                    .myBiodata?.data?.step6OccupationalInfo !=
                                null)
                              CustomExpansionTile(
                                  title: 'Occupational Info',
                                  children: [
                                    CustomBioDataTable(
                                      data: removeEmptyFields(
                                          generateOccupationalInfo()),
                                    )
                                  ]),
                            ...
                            if (controller.myBiodata?.data
                              ...
                              CustomExpansionTile(
                                ...
                                children: [
                                  CustomBioDataTable(
                                    data: removeEmptyFields(
                                        generateAuthorityQuestion()),
                                  )
                                ],
                              ),

                            // Contact Info Section
                            if (controller.myBiodata?.data?.step10ContactInfo != null)
                              CustomExpansionTile(
                                title: 'Contact Info',
                                children: [
                                  CustomBioDataTable(
  ...
  Map<String, String?> generateGeneralInfo() {
    final generalInfo = _controller.myBiodata?.data?.step1GeneralInfo;
    return {
  ...
  Map<String, String?> generateAddressInfo() {
    final addressInfo = _controller.myBiodata?.data?.step2AddressInfo;
    return {
  ...
  Map<String, String?> generateEduQualificationInfo() {
    final eduInfo = _controller.myBiodata?.data?.step3EduQualificationInfo;
    return {
  ...
  Map<String, String?> generateFamilyInfo() {
    final familyInfo = _controller.myBiodata?.data?.step4FamilyInfo;
    return {
  ...
  Map<String, String?> generatePersonalInfo() {
    final personalInfo = _controller.myBiodata?.data?.step5PersonalInfo;
    return {
  ...
  Map<String, String?> generateOccupationalInfo() {
    final occupationalInfo = _controller.myBiodata?.data?.step6OccupationalInfo;
    return {
  ...
  Map<String, String?> generateMarriageRelatedInfo() {
    final marriageInfo = _controller.myBiodata?.data?.step7MarriageRelatedInfo;
    return {
  ...
  Map<String, String?> generateExpectedLifePartnerInfo() {
    final partnerInfo = _controller.myBiodata?.data?.step8ExpectedPartnerInfo;
    return {
  ...
  Map<String, String?> generateAuthorityQuestion() {
    final authorityInfo =
        _controller.myBiodata?.data?.step9AuthorityQuestionsInfo;
    return {
  ...
  Map<String, String?> generateContactInfo() {
    final contactInfo = _controller.myBiodata?.data?.step10ContactInfo;
    return {
