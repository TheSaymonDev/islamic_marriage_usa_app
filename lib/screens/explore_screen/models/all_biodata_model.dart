  ...
  Data.fromJson(Map<String, dynamic> json) {
    if (json['biodatas'] != null) {
      ...
      json['biodatas'].forEach((v) {
        biodatas!.add(Biodatas.fromJson(v));
      });
    }
...
class Biodatas {
  ...
  Biodatas.fromJson(Map<String, dynamic> json) {
    sId = json['_id'];
    user = json['user'];
    ...
    step3EduQualificationInfo = json['step3EduQualificationInfo'] != null
        ? Step3EduQualificationInfo.fromJson(
        json['step3EduQualificationInfo'])
        : null;
    ...
    step7MarriageRelatedInfo = json['step7MarriageRelatedInfo'] != null
        ? Step7MarriageRelatedInfo.fromJson(
        json['step7MarriageRelatedInfo'])
        : null;
    step8ExpectedPartnerInfo = json['step8ExpectedPartnerInfo'] != null
        ? Step8ExpectedPartnerInfo.fromJson(
        json['step8ExpectedPartnerInfo'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (step3EduQualificationInfo != null) {
      data['step3EduQualificationInfo'] =
          step3EduQualificationInfo!.toJson();
    }
    ...
    if (step7MarriageRelatedInfo != null) {
      data['step7MarriageRelatedInfo'] =
          step7MarriageRelatedInfo!.toJson();
    }
    if (step8ExpectedPartnerInfo != null) {
      data['step8ExpectedPartnerInfo'] =
          step8ExpectedPartnerInfo!.toJson();
    }
